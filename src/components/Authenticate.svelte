...
<div class="auth__container">
    <form action="">
        ...
        <label for="email">
            <span class={email ? "above" : "center"}>Email</span>
            <input bind:value={email} type="email" name="email" placeholder="Email" id="email">
        </label>
        <label for="password">
            <span class={password ? "above" : "center"}>Password</span>
            <input bind:value={password} type="password" name="password" placeholder="Password" id="password">
        </label>
        {#if register}
            <label for="confirm">
                <span class={confirmPass ? "above" : "center"}>Confirm password</span>
